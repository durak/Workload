...
// Elegant ready-made solution I found to change tab key focus
/**
 * Some components treat tabulator (TAB key) in their own way. Sometimes the
 * tabulator is supposed to simply transfer the focus to the next focusable
 * component.
 * <br/>
 ...
 * </pre> This should do the trick. This time the KeyStrokes are used. More
 * elegant solution than TabTransfersFocus().
 *
 * @author kaimu
 * @since 2006-05-14
 * @version 1.0
